...
export interface TrackRecord {
  ...
  // Rich acoustic analysis (v0.16+ ANALYSIS_VERSION 6). All nullable — null
  // means the track hasn't been re-analysed yet; every consumer treats that as
  // "no signal, behave as before".
